...
### AI Badgr API
AI Badgr provides an OpenAI-compatible AI API for routing Cline model requests through Badgr-managed models or compatible upstream providers. Configure it in Cline with the **OpenAI Compatible** provider flow.

**Website:** [https://aibadgr.com/ai-api](https://aibadgr.com/ai-api)

#### Basic Setup

1. Create/sign in to AI Badgr and create an API key.
2. In Cline, choose **OpenAI Compatible**.
3. Set the base URL to `https://aibadgr.com/v1`, paste your API key, and enter the Badgr model ID you want to use.
